...
diagrams --- Visual Programming Languages has long existed, but received little
attention. This
thesis proposes an approach to representation of Clojure programming language,
that allows manipulation both as text and as diagram. This
