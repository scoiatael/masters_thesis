...
possibility to execute programs from editor,
\subsubsection*{Representation}
how program is presented,
\subsubsection*{Holes}
some editors suggest missing pieces (e.g. function arguments,
missing instruction blocks),
\subsubsection*{Comments}
programmers tend to leave additional information to future
readers,

\subsubsection*{Manual placement}
whether the editor itself, or the user, places
elements.

\subsubsection*{Functions}
ability to group and parametrise groups of code,

\subsubsection*{Modules}
ability to further cluster the code in named groups (and
